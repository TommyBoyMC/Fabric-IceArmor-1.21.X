...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        itemModelGenerator.register(ModItems.ICE_TOTEM, Models.GENERATED);
        itemModelGenerator.register(ModItems.ICE_MACE, Models.HANDHELD_MACE);

        itemModelGenerator.register(ModItems.ICE_UPGRADE_TEMPLATE, Models.GENERATED);

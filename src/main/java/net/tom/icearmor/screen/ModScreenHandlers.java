...
public class ModScreenHandlers {
    ...
    public static final ScreenHandlerType<DoubleFridgeScreenHandler> DOUBLE_FRIDGE_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(IceArmor.MOD_ID, "double_fridge_screen_handler"),
                    new ExtendedScreenHandlerType<>(DoubleFridgeScreenHandler::new, BlockPos.PACKET_CODEC));
